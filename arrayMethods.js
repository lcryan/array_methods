...
const yearOfBirth = inventors.filter((inventor) => {
  return inventor.year <= 1600 && inventor.year >= 1501;
});
...
const allYearsOfBirth = inventors.map((inventor) => {
  return inventor.year;
})

console.log(allYearsOfBirth);
...
let sortedByYearOfBirth = inventors.sort((a,b)=> {
  return a.year - b.year;
})

console.log(sortedByYearOfBirth);
